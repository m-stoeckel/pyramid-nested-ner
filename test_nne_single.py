...
def instantiate_datasets(lexicon, dataset_size=(1000, 100, 100)):
    ...
    train_dataloader = PyramidNerDataset(
        train_data,
        pyramid_max_depth=8,
    ...
    dev_dataloader = PyramidNerDataset(
        dev_data,
        pyramid_max_depth=8,
        token_lexicon=lexicon,
        entities_lexicon=entities_lexicon,
    ...
    test_dataloader = PyramidNerDataset(
        test_data,
        pyramid_max_depth=8,
        token_lexicon=lexicon,
        entities_lexicon=entities_lexicon,
